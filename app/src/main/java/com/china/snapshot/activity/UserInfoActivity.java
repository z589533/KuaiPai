...
public class UserInfoActivity extends BaseActivity {
    ...
    @BindView(R.id.edt_user_name_user_activty)
    EditText edtUserNameUserActivty;
    @BindView(R.id.edt_old_user_activity)
    EditText edtOldUserActivity;
    @BindView(R.id.edt_tell_user_activity)
    EditText edtTellUserActivity;
    @BindView(R.id.edt_mail_user_activity)
    EditText edtMailUserActivity;
    @BindView(R.id.btn_submit_user_activity)
    Button btnSubmitUserActivity;
